...
This configuration file is mandatory if you want to push your model in Acumos by CLI (CLI on-boarding). You have to copy
this file locally if you want to onboard your own models.
